...
metadata {
    definition (name: "Hue Motion Sensor", namespace: "mcornwall", author: "digitalgecko") {
...
// TODO : device watch?
    ...
    configCmds += zigbee.configureReporting(0x406,0x0000, 0x18, 0, 600, null) // motion configureReporting(cluster, attribute, datatype, mintime, maxtime, triggerDelta)
